...
webbrowser.open('https://t.me/itachihulala7878')
...
shanz = render('{HY HASU}', colors=['red', 'yellow'], align='center')
print(shanz)
print("\033[1;30m                тσσℓ ιѕ ρяσgяαммє∂ ву 𝐇𝐚𝐬𝐮 𝐈𝐬 𝐁𝐚𝐜𝐤 ")
print('\033[1;36m')
print("★" * 60)
print('')
######HASU#####
...
tok = input('• {}𝐁𝐨𝐭 𝐓𝐨𝐤𝐢𝐧 {}  {} : {}'.format(R, R, R, R))
print("\r")
iD = input('• {}𝐂𝐡𝐚𝐭 𝐈𝐃 {} {}: {}'.format(B, C, B, C))
os.system('clear')
...
def hunting(email):
  try:
    ...
    date = date_sc(Id)
    requests.post(
        f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/+HM4WE1MR3YQ3MmM1/157&caption=*• AAPKE LIYE ||*
""")
    hunt = ("""
